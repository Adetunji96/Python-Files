...
class Frames(object):
    ...
    def sel_theatre(self):
        ...
        theatre_1 = Button(newwin, text="Genesis Deluxe", fg="white", bg="red", width=40, height=3,
                           command= lambda: [ self.th1_assn()])
        theatre_1.place(x=50, y=100)

        theatre_2 = Button(newwin, text="VIVA", fg="white", bg="red", width=40, height=3,
                           command= lambda: [ self.th2_assn()])
        theatre_2.place(x=50, y=180)

        theatre_3 = Button(newwin, text="OOPL", fg="white", bg="red", width=40, height=3,
                           command= lambda: [ self.th3_assn()])
        theatre_3.place(x=50, y=260)

        theatre_4 = Button(newwin, text="Dews", fg="white", bg="red", width=40, height=3,
                           command= lambda: [ self.th4_assn()])
        theatre_4.place(x=50, y=340)

        theatre_5 = Button(newwin, text="Secret Cinema", fg="white", bg="red", width=40, height=3,
    ...
    def th_assign(self):
        ...
        def sel_movie(self):
            ...
            movie_2 = Button(newwin, text="Anikulapo", fg="white", bg="red", width=40, height=3,
                             command=lambda: [film_2(self)])
            movie_2.place(x=50, y=180)

            movie_3 = Button(newwin, text="The Passport", fg="white", bg="red", width=40, height=3,
                             command=lambda: [film_3(self)])
            movie_3.place(x=50, y=260)

            movie_4 = Button(newwin, text="Fast X", fg="white", bg="red", width=40, height=3,
                             command=lambda: [film_4(self)])
            movie_4.place(x=50, y=340)

            movie_5 = Button(newwin, text="Spiderman- No Way Home", fg="white", bg="red", width=40, height=3,
                             command=lambda: [film_5(self)])
            movie_5.place(x=50, y=420)

            movie_6 = Button(newwin, text="The Kujus Again", fg="white", bg="red", width=40, height=3,
        ...
        def film_2(self):
            ...
            disp_topper = Label(newwin, text="Shows available for 'Anikulapo'\n on " + self.date_disp.get() + " " +
                                self.month_disp.get() + ", " + self.day_disp.get() + " at " + hall, bg="grey", fg="white", height=3, width=50)
            disp_topper.pack()
        ...
        def film_3(self):
            ...
            global film_name
            film_name = "The Passport"

            disp_topper = Label(newwin, text="Shows available for 'The Passport'\n on " + self.date_disp.get() + " " +
                                self.month_disp.get() + ", " + self.day_disp.get() + " at " + hall, bg="grey", fg="white", height=3, width=50)
            disp_topper.pack()
        ...
        def film_4(self):
            ...
            disp_topper = Label(newwin, text="Shows available for 'Fast X'\n on " + self.date_disp.get() + " " +
                                self.month_disp.get() + ", " + self.day_disp.get() + " at " + hall, bg="grey", fg="white", height=3, width=50)
            disp_topper.pack()
        ...
        def film_5(self):
            ...
            disp_topper = Label(newwin, text="Shows available for 'Spiderman- No Way Home'\n on " + self.date_disp.get() + " " +
                                self.month_disp.get() + ", " + self.day_disp.get() + " at " + hall, bg="grey", fg="white", height=3, width=50)
            disp_topper.pack()
        ...
        def film_6(self):
            ...
            global film_name
            film_name = "The Kujus Again"

            disp_topper = Label(newwin, text="Shows available for 'The kujus Again'\n on " + self.date_disp.get() + " " +
                                self.month_disp.get() + ", " + self.day_disp.get() + " at " + hall, bg="grey", fg="white", height=3, width=50)
            disp_topper.pack()
        ...
        def seat_booking():
            ...
            def Payment():
                ...
                def cr_dr():
                    ...
                    ent_3 = Entry(newwin, show="*", width=20)
                    ...
                    nm_b2 = Label(newwin,
                                  text="By confirming you agree to the Terms \n and Conditions of ADETUNJI Movie Booking Limited",
                ...
                pay_summ = Label(newwin, text="Name of payer: "+self.query.get()+"\n\n Sub Total: #"+"{:.2f}".format(price)+
                                 "\n Handling fees: #6.87 \n Service Tax @ 14%: #"+"{:.2f}".format(tax), bg="grey", fg="white",
                                 height=7, width=50)
                pay_summ.place(x=20, y=60)

                tot_sum = Label(newwin, text="Total amount to be paid: #"+"{:.2f}".format(total), bg="red", fg="white",
                                height=1, width=50)
            ...
            def dis():
                ...
                book_detail = Label(newwin, text="Theatre: "+hall+"\n Movie: "+film_name+"\n"+screen+"\n Timing: "+show_time+
                                    "\n\n Seats Selected: "+var+"\n Price: #"+"{:.2f}".format(price), bg="grey", fg="white", height=7, width=40)
            ...
            lb_prices = Label(newwin, text="Blue code seats are #1000 each \n Green code seats are #800 each \n"
                                           "Yellow code seats are #1500 each", bg="red", fg="white", height=5, width=60)
    ...
    def newWindow(self):  # new window definition
        ...
        display_name = Label(newwin, text="Enter your Name", fg="white", bg="blue", width=20, height=3)
        display_name.pack()

        entry_name = Entry(newwin, width=50, textvariable=self.query)
        entry_name.pack()

        display_email = Label(newwin, text="Enter your Email-address", fg="white", bg="blue", width=20, height=3)
        display_email.pack()

        entry_email = Entry(newwin, width=50, textvariable=self.query1)
        entry_email.pack()

        display_age = Label(newwin, text="Enter your age", fg="white", bg="blue", width=20, height=3)
        display_age.pack()
    ...
    def mainFrame(self, root):
        ...
        title = Label(root, text="WELCOME TO ADETUNJI MOVIE BOOKING SYSTEM", fg="white", bg="green", width=350, height=200)
        title.pack()
    

        button1 = Button(root, text="Proceed to Booking", command=lambda: [ self.newWindow()])
        button1.place(x=430, y=530, width=150, height=40)
